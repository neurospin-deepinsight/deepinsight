...
cmd = ["sphinxdoc", "-v 2", "-p",  installdir, "-n", "deepinsight", "-o", "..",
       "-i", "deepinsight"]
...
# Configure gallery
sphinx_gallery_conf = {
    "doc_module": "deepinsight",
    "backreferences_dir": os.path.join("deepinsight", "gallery"),
...
project = u"deepinsight"
copyright = u"""{0}, deepinsight developers <antoine.grigis@cea.fr>""".format(
...
html_title = "deepinsight"

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = "deepinsight"
...
# [howto/manual]).
latex_documents = [
    ("index", "deepinsight.tex", "deepinsight Documentation", """deepinsight developers""",
     "manual"),
]
